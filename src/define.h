...
GLfloat light_0_diffintensity[] = {0.2f, 0.2f, 0.2f, 1.0f};
GLfloat light_0_ambient[] = {0.2f, 0.2f, 0.2f, 1.0f};
//GLfloat light_0_ambient[] = {1.f, 1.f, 1.f, 1.f};

// spot light
GLfloat light_1_direction[] = {-0.286648f, -0.62188f, -0.728765f, 0.f};
GLfloat light_1_position[] = {5.f, 13.f, 14.f, 1.0f};
